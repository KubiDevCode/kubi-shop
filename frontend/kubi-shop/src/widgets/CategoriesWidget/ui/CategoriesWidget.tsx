    ...
    <section className="py-10">
      <Container>
        <div className="mb-10 flex items-center gap-4">
          <p className="text-lg uppercase tracking-wide text-gray-600">Categories</p>
        ...
        <div className="grid grid-cols-6 gap-4">
          {isLoading
            ? Array.from({ length: 6 }).map((_, index) => (
                <div
                  key={index}
                  className="flex flex-col justify-between w-45 h-56.25 rounded-xl border border-gray-200 bg-white p-6.25"
                >
